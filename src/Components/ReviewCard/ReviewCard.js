...
import BodyCardText from "./CardBody/BodyCardText";
  ...
  return (
    ...
    >
      ...
      <CardContent style={{ paddingBottom: 0, paddingTop: 0 }}>
        ...
        <BodyCardText
          title={`${textContainer.reviewCard.body.pros}:`}
          text={croppedText.pros}
        />

        {croppedText.cons.length != 0 && (
          <BodyCardText
            title={`${textContainer.reviewCard.body.cons}:`}
            text={croppedText.cons}
          />
        )}
